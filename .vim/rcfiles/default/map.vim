...
nnoremap <silent> [BlankLine]j     :<C-u>for i in range(1, v:count1)|call append(line('.'),   '')|endfor<CR>
nnoremap <silent> [BlankLine]k     :<C-u>for i in range(1, v:count1)|call append(line('.')-1, '')|endfor<CR>
